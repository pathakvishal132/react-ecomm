            ...
            <div className="background">
                <div className="container">
                    <div className="screen">
                        ...
                        <div className="screen-body">
                            <div className="screen-body-item left">
                                ...
                                <div className="app-contact">CONTACT INFO : +91 7727872538</div>
                            </div>
                    ...
                    <div className="credits">
                        inspired by
                        <a className="credits-link" href="https://portfolio2himansupathak.vercel.app" target="_blank" rel="noreferrer">
